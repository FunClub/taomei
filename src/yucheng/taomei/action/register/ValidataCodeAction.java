...
@Component("validataCodeAction")
@Scope(scopeName=ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public class ValidataCodeAction {
	private static final int IMG_HEIGHT = 60;// 验证码图片高度
	private static final int IMG_WIDTH = 120;// 验证码图片宽度
	...
	public String execute() throws IOException {
		...
		// 7.将随机数存在session中
		request.getSession().setAttribute("validataCode", random);
